<meta charset="utf-8">
     <title>Mobile Application Development Service Provider in Pune</title>
...
<?php include 'header.php';?>
   ...
   <div id="banner-area" class="banner-area" style="background-image:url(images/banner/b12.jpg)">
      <div class="banner-text">
         <div class="container">
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     <h1 class="banner-title">Mobile Application</h1>
                     <ol class="breadcrumb">
                        <li>Home</li>
                        <!-- <li>Services</li> -->
