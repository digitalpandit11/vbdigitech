<meta charset="utf-8">
     <title>Website Development & Digital Marketing Service Provider in Pune</title>
...
<?php include 'header.php';?>
   ...
   <div id="banner-area" class="banner-area" style="background-image:url(images/banner/b6.jpg)">
      <div class="banner-text">
         <div class="container">
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     <h1 class="banner-title">Custom Software</h1>
                     <ol class="breadcrumb">
                        <li>Home</li>
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  ...
                  <div class="ts-service-info">
                     ...
                     <p class="jt">You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor sit amet integer suscipit.</p>
                     <p class="jt"><a class="learn-more" href="service-single.html"><i class="fa fa-caret-right"></i> Learn More</a></p>  
                  </div>
               </div><!-- Service1 end -->
            </div><!-- Col 1 end -->
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-image-wrapper">
                     <img class="img-responsive" src="images/services/service4.jpg" alt="">
                  </div>
                  <div class="ts-service-box-img pull-left">
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-image-wrapper">
                        <img class="img-responsive" src="images/services/service5.jpg" alt="">
                  </div>
                  <div class="ts-service-box-img pull-left">
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-image-wrapper">
                        <img class="img-responsive" src="images/services/service6.jpg" alt="">
                  </div>
                  <div class="ts-service-box-img pull-left">
