...
/*
	Copyright 2021  Tim Eckel  (email : eckel.tim@gmail.com)
...
function read_more_excerpt_link_menu_options() {
	...
	if( isset($_POST[ 'read_more_excerpt_link_submit_hidden' ]) && $_POST[ 'read_more_excerpt_link_submit_hidden' ] == 'Y' ) {
		if ( isset( $_POST[ 'read_more_excerpt_link_text' ] ) ) $link_val = filter_var ( $_POST[ 'read_more_excerpt_link_text' ], FILTER_SANITIZE_STRING );
