			...
			<div class="site-generator">
				...
				<div class="container">
					...
					<span class="copy-right">
						...
						<span class="copyright-text"><?php echo esc_html( get_theme_mod( 'web_app_copyright_text',esc_html__('2018 Web App','web-app')));?></span>
							<?php 						 

								printf( esc_html__( 'Web App  by %1$s.', 'web-app' ), '<a href="'.esc_url( 'https://theme404.com/' ).'" rel="designer">'.esc_html__('Theme 404', 'web-app').'</a>' ); ?>
