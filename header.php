...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-138588483-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-138588483-1');
</script>
	...
	<link rel="icon" href="images/fav1.png" sizes="40x40">
  ...
  <meta name="google-site-verification" content="OZGFjRNlRhdkt9N6scRKiuFrQYEI1ETndw8j0e-u55U" />
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 top-social text-right">
						<ul class="unstyled">
							<li>
								<a title="Facebook" href="https://www.facebook.com/VB.Digitech" target="_blank">
								...
								<a title="Linkedin" href="https://www.linkedin.com/company/vb-digitech-website-development-digital-marketing-services/about/" target="_blank">
						...
						<div class="col-xs-12 col-md-9 header-right" style="margin-top: 17px;">
							<ul class="top-info-box">
								...
								<li class="social-media">
									...
									<a title="Twitter" href="https://twitter.com/DigitechVb" target="_blank">
										<span class="social-icon"><i class="fa fa-twitter"></i></span>
									</a>
									<a title="Instagram" href="https://www.instagram.com/vbdigitech/" target="_blank">
										<span class="social-icon"><i class="fa fa-instagram"></i></span>
									</a>
									<a title="Linkedin" href="https://www.linkedin.com/company/vb-digitech-website-development-digital-marketing-services/about/" target="_blank">
										<span class="social-icon"><i class="fa fa-linkedin"></i></span>
              ...
              <div class="site-nav-inner pull-left">
                ...
                <div class="collapse navbar-collapse navbar-responsive-collapse">
                  <ul class="nav navbar-nav">
					...
					<li ><a href="business-automation.php">Business Automation</a></li>
